...
model.save_weights("F:/Waseem_Data/Two_CNN_stream/UCF-Crime/demo/weights.h5")
model.save_weights("D:/Violance_datasets/HockeyFights_Arrange_Features/Model/weights.weights")
model.save('D:/Violance_datasets/HockeyFights_Arrange_Features/Model/fine_tune_model_two_steam_ESN.h5')
model.save_weights('ESN.h5')
tmpdir = tempfile.mkdtemp()
mobilenet_save_path = os.path.join(tmpdir, "D:/Violance_datasets/HockeyFights_Arrange_Features/Model/")

from keras.models import load_model
model.load_weights('F:/Waseem_Data/Two_CNN_stream/UCF-Crime/ESN/Final\Model/fine_tune_model_two_steam_ESN_final.h5')
