...
history=model.fit([X_train_OP,X_train_I3D] ,y_train_OP,batch_size=128, epochs=2,validation_data=([X_val_OP,X_val_I3D], y_val_OP))
...
model.save_weights("F:/Waseem_Data/Two_CNN_stream/UCF-Crime/demo/weights.weights")
