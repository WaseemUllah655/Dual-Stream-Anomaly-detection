...
#x1 = Dropout(0.5)(x1)
#
x1 = Dense(64, activation='relu')(recurrent_layer)
...
history=model.fit([X_train_OP,X_train_I3D] ,y_train_OP,batch_size=64,epochs=200,validation_data=([X_val_OP,X_val_I3D], y_val_OP))

# plot graph
#plot_model(model, to_file='multiple_inputs.png')
model.save('D:/Violance_datasets/Violentflow/Results_ESN/Models/fine_tune_model_two_steam_ESN.h5')
model.save_weights('D:/Violance_datasets/Violentflow/Results_ESN/Models/fine_tune_model_weight_two_steam_ESN')
...
model.save('D:/Violance_datasets/Violentflow/Results_ESN/Models//Two-stream-ESN.h5')
...
plt.savefig("D:/Violance_datasets/Violentflow/Results_ESN/ROC_ESN.jpg")
plt.show()
...
df.figure.savefig("D:/Violance_datasets/Violentflow/Results_ESN/image.png")
