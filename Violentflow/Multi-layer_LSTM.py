...
batch_size = 128
epochs = 20
X_vgg = np.vstack(Violance_dataset_features_efn_2_classes_b7)
...
train_features_final_15frames = np.vstack(Violance_datasets_3dd_features_2classes_refine)
...
y_train_pf= Violance_datasets_3dd_labels_2classes_refine
...
x1 = LSTM(256, return_sequences=False, name = 'LSTM_1')(inputA)
#x1 = GRU(256, return_sequences=False, name = 'LSTM_2')(x1)
#
...
history=model.fit([X_train_OP,X_train_I3D] ,y_train_OP,batch_size=batch_size, epochs=200,validation_data=([X_val_OP,X_val_I3D], y_val_OP))
# summarize layers

# plot graph
#plot_model(model, to_file='multiple_inputs.png')
model.save('D:/Violance_datasets/Violentflow/Results_LSTM/Models/fine_tune_model_two_steam_LSTM.h5')
model.save_weights('D:/Violance_datasets/Violentflow/Results_LSTM/Models/fine_tune_model_weight_two_steam_LSTM')
...
model.save('D:/Violance_datasets/Violentflow/Results_LSTM/Models//Two-stream-LSTM.h5')
...
target_names = ['Violence', 'NonViolence']
...
cm_plot_labels=['Violence', 'NonViolence']
...
plt.savefig("D:/Violance_datasets/Violentflow/Results_LSTM/ROC_LSTM.jpg")
plt.show()
...
df.figure.savefig("D:/Violance_datasets/Violentflow/Results_LSTM/image.png")
