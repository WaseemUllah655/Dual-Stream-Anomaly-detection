...
inputB=(1024)
x1 = GRU(256, return_sequences=True, name = 'LSTM_1')(inputA)
...
history=model.fit([X_train_OP,X_train_I3D] ,y_train_OP,batch_size=batch_size, epochs=20,validation_data=([X_val_OP,X_val_I3D], y_val_OP))
# summarize layers
