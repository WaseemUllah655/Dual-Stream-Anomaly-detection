...
history=model.fit([X_train_OP,X_train_I3D] ,y_train_OP,batch_size=batch_size, epochs=50,validation_data=([X_val_OP,X_val_I3D], y_val_OP))
# summarize layers

# plot graph
#plot_model(model, to_file='multiple_inputs.png')
model.save('fine_tune_model_two_steam_LSTM.h5')
model.save_weights('fine_tune_model_weight_two_steam_LSTM')
