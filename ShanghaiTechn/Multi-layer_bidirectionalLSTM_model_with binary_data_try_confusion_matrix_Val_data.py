# -*- coding: utf-8 -*-
"""
Created on Mon Feb 17 23:11:03 2020
...
y_test_pf =Test_Shanghaitech_refine_3dd_features_2classes
...
recurrent_layer = keras.layers.RNN(cell, return_sequences=False, name="ESN", dynamic=True)(inputA)
...
#x1 = Dropout(0.5)(x1)
#
x1 = Dense(256, activation='relu')(recurrent_layer)
...
history=model.fit([X_train_OP,X_train_I3D] ,y_train_OP,batch_size=batch_size, epochs=20,validation_data=([X_val_OP,X_val_I3D], y_val_OP), callbacks = [tboard_callback])
# summarize layers
...
#
y_pred = (pred > 0.5)*1 
confusion = confusion_matrix(X_val_OP.argmax(axis=1), y_pred.argmax(axis=1))
