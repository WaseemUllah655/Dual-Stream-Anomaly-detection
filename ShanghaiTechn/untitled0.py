...
x1 = Bidirectional(GRU(256, return_sequences=False, name = 'LSTM_2'))(recurrent_layer)
#
...
model.save('fine_tune_model_two_steam.h5')
model.save_weights('fine_tune_model_weight_two_steam')
