...
model.save('fine_tune_model_two_steam_Gru.h5')
model.save_weights('fine_tune_model_weight_two_steam_GRU')
...
model.save('F:\Waseem_Data\Two_CNN_stream\ShanghaiTechn\Result of ShanghaiTech\GRU\Models\Two-stream-CNN.h5')
